...
"endif
"
"" Highlight Razor comments (e.g. @* comment *@)
"syn region razorComment start="@\*" end="\*@" containedin=razorDirective,razorString,razorNumber,razorHTMLTag,razorHTMLAttr
"
"" Highlight Razor directives (e.g. @page, @attribute, etc.)
"syn match razorDirective /@\w\+/
"
"" Highlight string literals within Razor code
"syn match razorString /"\([^"\\]\|\\.\)*"/
"
"" Highlight numbers (integers and floating point)
"syn match razorNumber /\v\d+(\.\d+)?/
"
"" Highlight HTML tags and attributes
"syn match razorHTMLTag /<\w\+/
"syn match razorHTMLAttr /\(\w\+\)=/
"
"" Highlight inline style and attribute values
"syn match razorHTMLStyle /style="[^"]*"/
"
"" Link the syntax groups to predefined highlighting groups
"hi def link razorDirective Keyword
...
"hi def link razorHTMLAttr String
"hi def link razorHTMLStyle Special
" =====================================
